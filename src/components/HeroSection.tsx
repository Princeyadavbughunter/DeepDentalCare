  ...
  return (
    <section className="p-4 md:p-8 lg:p-12 max-w-7xl mx-auto">
      <h1 className="text-2xl md:text-4xl lg:text-5xl font-bold text-center mb-6 leading-tight">
        ...
        <span className="text-[#01659e]">Deep Dental Care</span>
      </h1>
      ...
      <div className="md:flex md:items-center md:gap-8 md:mb-12">
        <div className="relative rounded-lg h-48 md:h-[400px] mb-6 md:mb-0 md:flex-1 overflow-hidden shadow-lg">
          <div className="relative rounded-lg h-48 md:h-[400px] mb-6 md:mb-0 md:flex-1 overflow-hidden shadow-lg bg-black">
            <iframe
              ...
              src="https://www.youtube.com/embed/fHGV6Q-qIuc?si=fk1CAwDu7MHf_0TF"
              title="Deep Dental Care Video"
        ...
        <div className="bg-gradient-to-r from-black to-gray-800 text-white p-6 rounded-xl text-center mb-6 md:mb-0 md:flex-1">
          ...
          <div className="text-lg md:text-xl font-medium space-y-2 mb-6">
            <p>Dental Implants: <span className="text-yellow-400">₹25,000 onwards</span></p>
            <p className="text-base text-gray-300">EMI Facility: To be confirmed</p>
          </div>
          <button
      ...
      <div className="bg-gray-50 p-4 md:p-8 rounded-lg md:max-w-3xl md:mx-auto">
        ...
        <ul className="space-y-2 mb-4">
          <li className="flex items-start gap-2">
            ...
            <span className="text-sm md:text-base">17+ Years of Excellence
              Caring for smiles with dedication and trust</span>
          </li>
          <li className="flex items-start gap-2">
            <span className="text-[#01659e]">✔</span>
            <span className="text-sm md:text-base">Advanced Corticobasal Implants for immediate loading—get your fixed teeth in just 3 days.</span>
          </li>
          <li className="flex items-start gap-2">
            <span className="text-[#01659e]">✔</span>
            <span className="text-sm md:text-base">Minimally invasive, keyhole surgery technique ensuring a virtually painless experience with no swelling.</span>
          </li>
          <li className="flex items-start gap-2">
            <span className="text-[#01659e]">✔</span>
            <span className="text-sm md:text-base">State-of-the-art 3D Bone Scanners for 100% precision in implant placement.</span>
          </li>
          <li className="flex items-start gap-2">
            <span className="text-[#01659e]">✔</span>
            <span className="text-sm md:text-base">Lifetime Warranty on implants with a success rate of over 99%.</span>
          </li>
        </ul>
